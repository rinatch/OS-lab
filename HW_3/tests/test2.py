...
def main():
    ...
    print("test 2 - write 2 packages and read 2 packages")
    pid = os.getpid()
    #
    ...
    # Write a message
    message = '1111111111'
    message2 = '222222222222'
    os.write(f2, message)
    os.write(f2, message2)
    ...
    packet_str2 = os.read(f1, 1600)
    packet_str3 = os.read(f1, 1600)

    # Unpack the message to it's easier to work with
    ...
    # Unpack the message to it's easier to work with
    packet = unpack_packet(packet_str2)
    # print("before assert2")
    # print(packet['payload'])
    # print(message2)
    assert (message2 == packet['payload'])
    assert (packet['source_file'] == 1)
    assert (packet['source_pid'] == pid)
