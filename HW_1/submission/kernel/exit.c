...
#include <linux/tty.h>
#include <linux/procenet_structs.h>//todo: activate
...
static void release_task(struct task_struct * p)
{
    ...
    //HW1 change start:
//todo: activate
    //release procenet dynamically allocated memory
    list_t *invitations_it_curr; //invitations list iterator
    list_t *invitations_it_next; //invitations list iterator
    struct invitations_list_node *current_inv;
    list_for_each_safe(invitations_it_curr,invitations_it_next,&p->invitations){
        current_inv = (struct invitations_list_node*)list_entry(invitations_it_curr,struct invitations_list_node,ptr);
        kfree(current_inv);
    }
    //HW1 change end!
