...
#include <linux/tty.h>
//#include <linux/procenet_structs> //todo: activate
...
//todo: activate
    ...
    struct invitation_t *current_inv;
    list_for_each_safe(invitations_it_curr,invitations_it_next,&p->invitations){
        current_inv = (struct invitation_t*)list_entry(invitations_it_curr,struct invitation_t,l_idx);
        free(current_inv);
    }*/ 
